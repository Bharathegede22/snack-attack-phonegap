...
// src: https://github.com/stripe/jquery.payment
(function() {
  ...
  cards = [
    {
      ...
      type: 'generic',
      pattern: /^(35|62|88)|^6([045]|22)|^5019/,
      format: defaultFormat,
      length: [19],
      cvcLength: [3],
      luhn: true
  ...
  $.payment.checkLuhn = function(num) {
    var digit, digits, odd, sum, _i, _len;
    odd = true;
    sum = 0;
    digits = (num + '').split('').reverse();
